      ...
      <div className={styles.error404body}>
        <div className={styles.container}>
          ...
          <ul>
            <li>
              {" "}
              You are a <code>All-time</code> Unlucky person, Thus.{" "}
            </li>
            ...
            <li>
              {" "}
              You Mistyped a <strong>URL</strong>, Thus.{" "}
            </li>
            <li>
              {" "}
              You Followed a <strong>OLD, DEAD, BROKEN</strong> url, Thus.{" "}
            </li>
            <li> Or you are just missing Windows Blue Screen, Thus. </li>
          </ul>
          <p>
            'nough Said, Now{" "}
            <span onClick={() => navigate(-1)} className={styles.link}>
              Go Back
            </span>{" "}
            // Or Return To{" "}
