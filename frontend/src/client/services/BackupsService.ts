...
export class BackupsService {
   ...
   * @throws ApiError
   */
  public static getMulti(skip?: number, limit: number = 100, sort?: string): CancelablePromise<Array<Backup>> {
  ...
  public static getMultiWithHeaders(skip?: number, limit: number = 100, sort?: string) {
    return requestWithHeaders<Backup[]>(OpenAPI, {
      method: "GET",
      url: "/api/backups/",
      query: {
        skip: skip,
   ...
   * @throws ApiError
   */
  public static restore(backupId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static delete(backupId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
