...
export class GenresService {
  ...
  public static getMultiWithHeaders(
    ...
    return requestWithHeaders<Genre[]>(OpenAPI, {
      method: "GET",
      url: "/api/genres/",
      query: {
        skip: skip,
   ...
   * @throws ApiError
   */
  public static create(requestBody: GenreCreate): CancelablePromise<Genre> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/genres/",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static get(genreId: string): CancelablePromise<Genre> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static delete(genreId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/genres/{genre_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static update(genreId: string, requestBody: GenreUpdate): CancelablePromise<Genre> {
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/genres/{genre_id}",
      path: {
