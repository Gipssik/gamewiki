...
export class PlatformsService {
  ...
  public static getMultiWithHeaders(
    ...
    return requestWithHeaders<Platform[]>(OpenAPI, {
      method: "GET",
      url: "/api/platforms/",
      query: {
        skip: skip,
   ...
   * @throws ApiError
   */
  public static create(requestBody: PlatformCreate): CancelablePromise<Platform> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/platforms/",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static get(platformId: string): CancelablePromise<Platform> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static delete(platformId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/platforms/{platform_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static update(platformId: string, requestBody: PlatformUpdate): CancelablePromise<Platform> {
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/platforms/{platform_id}",
      path: {
