...
export class GamesService {
  ...
  public static getMultiWithHeaders(
    ...
    return requestWithHeaders<Game[]>(OpenAPI, {
      method: "GET",
      url: "/api/games/",
      query: {
        skip: skip,
   ...
   * @throws ApiError
   */
  public static create(requestBody: GameCreate): CancelablePromise<Game> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/games/",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static get(gameId: string): CancelablePromise<Game> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static delete(gameId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/games/{game_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static update(gameId: string, requestBody: GameUpdate): CancelablePromise<Game> {
    return __request(OpenAPI, {
      method: "PATCH",
      url: "/api/games/{game_id}",
      path: {
